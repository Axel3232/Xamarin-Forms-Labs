...
using XLabs.Samples.Pages.Controls;
using XLabs.Samples.Pages.Controls.Charts;
using XLabs.Samples.Pages.Controls.DynamicList;
using XLabs.Samples.Pages.Mvvm;
using XLabs.Samples.Pages.Samples;
