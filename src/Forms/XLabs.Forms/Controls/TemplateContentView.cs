...
namespace XLabs.Forms.Controls
{
    ...
    public class TemplateContentView<T> : ContentView
    {
        ...
        public static readonly BindableProperty TemplateSelectorProperty = 
            BindableProperty.Create(nameof(TemplateSelector), typeof(TemplateSelector), typeof(TemplateContentView<T>), default(TemplateSelector));
        /// <summary>
        /// Property definition for the <see cref="ViewModel"/> Property
        /// </summary>
        public static readonly BindableProperty ViewModelProperty = 
            BindableProperty.Create(nameof(ViewModel), typeof(T), typeof(TemplateContentView<T>), default(T),BindingMode.OneWay,null,ViewModelChanged);

        /// <summary>
        /// The item template selector property
        /// </summary>
        public static readonly BindableProperty ItemTemplateSelectorProperty = 
            BindableProperty.Create(nameof(ItemTemplateSelector), typeof(DataTemplateSelector), typeof(TemplateContentView<T>), default(DataTemplateSelector), propertyChanged: OnDataTemplateSelectorChanged);
        ...
        {
            ((TemplateContentView<T>)bindable).OnDataTemplateSelectorChanged((DataTemplateSelector)oldvalue, (DataTemplateSelector)newvalue);
        }
...
#pragma warning restore CS1711 // XML comment has a typeparam tag, but there is no type parameter by that name
        {
            ...
            layout.ViewModelChangedImpl((T)newValue);
        }
        #endregion
