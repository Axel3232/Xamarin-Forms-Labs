...
namespace XLabs.Forms
{
    ...
    /// </summary>
    public class XFormsCompactApplicationDroid : FormsAppCompatActivity
    {
        /// <summary>
    ...
    /// </summary>
    public class XFormsAppCompactDroid : XFormsApp<XFormsCompactApplicationDroid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XFormsAppDroid"/> class.
        /// </summary>
        public XFormsAppCompactDroid() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="XFormsAppDroid"/> class.
        /// </summary>
        /// <param name="app">The application.</param>
        public XFormsAppCompactDroid(XFormsCompactApplicationDroid app) : base(app) { }
        ...
        protected override void OnInit(XFormsCompactApplicationDroid app, bool initServices = true)
        {
