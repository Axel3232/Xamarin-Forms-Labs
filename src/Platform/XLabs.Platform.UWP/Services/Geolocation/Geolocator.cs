namespace XLabs.Platform.Services.Geolocation
{
 ...
 //   public class Geolocator : IGeolocator
	...
	//	public async Task<Location> GetPositionAsync(int timeout)
	//	{
	...
	//	/// <returns>Task&lt;Position&gt;.</returns>
	//	public async Task<Location> GetPositionAsync(int timeout, bool includeHeading)
	//	{
	...
	//	/// <returns>Task&lt;Position&gt;.</returns>
	//	public async Task<Location> GetPositionAsync(CancellationToken cancelToken)
	//	{
	...
	//	/// <param name="includeHeading">if set to <c>true</c> [include heading].</param>
	//	/// <returns>Task&lt;Position&gt;.</returns>
	//	public Task<Location> GetPositionAsync(CancellationToken cancelToken, bool includeHeading)
	//	{
	...
	//	/// <param name="cancelToken">The cancel token.</param>
	//	/// <returns>Task&lt;Position&gt;.</returns>
	//	public Task<Location> GetPositionAsync(int timeout, CancellationToken cancelToken)
	//	{
	...
	//	/// <param name="includeHeading">if set to <c>true</c> [include heading].</param>
	//	/// <returns>Task&lt;Position&gt;.</returns>
	//	public Task<Location> GetPositionAsync(int timeout, CancellationToken cancelToken, bool includeHeading)
	//	{
